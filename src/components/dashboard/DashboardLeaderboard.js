  ...
  return (
    <>
      {leaderboard.yourRank ? (
        <div className="mx-6 sm:mx-8 mt-4 rounded-2xl border border-amber-200/80 bg-white/90 px-4 py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <p className="mx-6 sm:mx-8 mt-4 text-sm text-neutral-500 rounded-xl bg-neutral-50 border border-neutral-100 px-4 py-3">
      ...
      <ol className="divide-y divide-neutral-100 mt-4">
        {leaderboard.entries.map((e) => (
          <li
            key={e.userEmail}
            className="flex items-center gap-3 px-6 sm:px-8 py-3.5 hover:bg-neutral-50/80 transition-colors"
          >
...
export default function DashboardLeaderboard({
  ...
  if (loading) {
    return (
      <section className="rounded-3xl border border-neutral-200 bg-white shadow-sm overflow-hidden animate-pulse">
  ...
  return (
    <section className="rounded-3xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
      <div className="relative bg-gradient-to-br from-amber-50 via-white to-orange-50 border-b border-neutral-100 px-6 sm:px-8 py-5">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-lg font-bold text-neutral-900">Leaderboards</h2>
              <p className="text-sm text-neutral-600 mt-0.5">
                Overall mock rankings · {activeLabel}
              </p>
            </div>
          </div>
          {activeSlug ? (
