...
import ArticleEmbeds from '@/components/articles/ArticleEmbeds';
import FeaturedArticleImage from '@/components/articles/FeaturedArticleImage';
...
import { RELATED_PAGE_SIZE, estimateReadMinutes } from '@/lib/articles/fetchArticle';
import { normalizeArticleContent } from '@/lib/articles/normalizeArticleContent';
...
export default async function ArticleDetailContent({
  ...
  const bodyHtml = normalizeArticleContent(article.content);
